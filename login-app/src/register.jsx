...
function Register(){
    ...
    return (
        <>
        <div className="bg-black/90 text-center flex flex-col items-center">
            ...
            <div className="bg-black text-center rounded-lg my-10 font-bold text-emerald-400" >
                <h1 className="pt-4 pb-1 text-3xl">Result </h1>
                <p className="w-90 text-xl h-10">{message}</p>
            </div>
